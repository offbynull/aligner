    ...
    public:
        ...
        alignment_result auto align_strict(
            ...
            > gated_substitution_scorer {
                down.size(),  // down_double's being consumed (2x down), but once it consumes just 1x, kill the scorer
                right.size(),
                substitution_scorer
            };
            consumption_gating_scorer<
            ...
            >;
            consumption_gating_limits<debug_mode, N_INDEX> gating_limits { down.size(), right.size() };
