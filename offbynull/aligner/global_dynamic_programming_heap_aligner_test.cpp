...
namespace {
    using offbynull::aligner::global_dynamic_programming_heap_aligner::dynamic_programming_heap_allocation_strategy_config;
    using offbynull::aligner::global_dynamic_programming_heap_aligner::global_dynamic_programming_heap_aligner;
    using offbynull::aligner::scorers::simple_scorer::simple_scorer;
    using offbynull::utils::is_debug_mode;

    TEST(OAGlobalDynamicProgrammingHeapAlignerTest, SanityTest) {
