...
namespace {
    ...
    TEST(OAGPairwiseGlobalAlignmentGraphTest, DiagionalWalk1) {
        std::string seq1 { "a" };
        std::string seq2 { "ac" };
        pairwise_global_alignment_graph<
            is_debug_mode(),
    ...
    TEST(OAGPairwiseGlobalAlignmentGraphTest, DiagionalWalk2) {
        std::string seq1 { "ac" };
        std::string seq2 { "a" };
        pairwise_global_alignment_graph<
            is_debug_mode(),
    ...
    TEST(OAGPairwiseGlobalAlignmentGraphTest, DiagionalWalk3) {
