...
namespace offbynull::aligner::graph::graph {
     ...
     * @ref offbynull::aligner::graph::graph::graph's node identifier:
     *
     ...
     * @ref offbynull::aligner::graph::graph::graph's edge identifier.
     *
     *  * Must be copyable / moveable.
     *  * Must be comparable using equality and inequality (`==` and `!=` operators).
     *
    ...
    /**
     * Concept that's satisfied if `T` is a range (not a reference, not CV-qualified) of tuples, where each tuple contains the edge
     * identifier, source node identifier, destination node idetifier, and edge data (`tuple<E, N, N, ED>`). Const, volatile, and references
     * are removed from each item before checking types.
     *
     * @tparam T Type of check (non-cvref).
     * @tparam N Node identifier type (non-cvref).
     * @tparam E Edge identifier type (non-cvref).
    ...
    struct unimplemented_graph {
         ...
         *
         * @param e Edge identifier.
         * @return Identifier of `e`'s source node.
         */
         ...
         *
         * @param e Edge identifier.
         * @return Identifier of `e`'s destination node.
         */
         ...
         *
         * @param e Edge ID.
         * @return Identifier of `e`'s source node, identifier of `e`'s destination node, and `e`'s data.
         */
         ...
         * Get root nodes.
         *
         * @return Identifiers of root nodes. This range may be lazily evaluated, meaning the behavior of this range becomes undefined once
         *     this graph is modified in any way.
         */
         ...
         *
         * @return Identifier of root node.
         */
         ...
         * Get leaf nodes.
         *
         * @return Identifiers of leaf nodes. This range may be lazily evaluated, meaning the behavior of this range becomes undefined once
         *     this graph is modified in any way.
         */
         ...
         *
         * @return Identifier of leaf node.
         */
         ...
         * List all nodes.
         *
         * @return Node identifiers. This range may be lazily evaluated, meaning the behavior of this range becomes undefined once this
         ...
         * List all edges.
         *
         * @return Edge identifiers. This range may be lazily evaluated, meaning the behavior of this range becomes undefined once this
         *     graph is modified in any way.
         */
         ...
         *
         * @param n Node identifier.
         * @return Edges where `n` is the source node. Each returned edge includes the edge's identifier, the edge's source and destination
         *     (node identifiers), and the data associated with that edge. This range may be lazily evaluated, meaning the behavior of this
         *     range becomes undefined once this graph is modified in any way.
         */
         ...
         *
         * @param n Node identifier.
         * @return Edges where `n` is the destination node. Each returned edge includes the edge's identifier, the edge's source and
         *     destination (node identifiers), and the data associated with that edge. This range may be lazily evaluated, meaning the
         *     behavior of this range becomes undefined once this graph is modified in any way.
         */
         ...
         *
         * @param n Node identifier.
         * @return Identifiers of edges where `n` is the source node. This range may be lazily evaluated, meaning the behavior of this range
         ...
         *
         * @param n Node identifier.
         * @return Identifiers of edges where `n` is the destination node. This range may be lazily evaluated, meaning the behavior of this
         *     range becomes undefined once this graph is modified in any way.
         */
