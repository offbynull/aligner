#ifndef OFFBYNULL_ALIGNER_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
#define OFFBYNULL_ALIGNER_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
...
namespace offbynull::aligner::global_dynamic_programming_heap_aligner {
     ...
     */
    template<typename T>
    concept dynamic_programming_heap_allocation_strategy = requires {
        { T::minimize_allocations } -> std::same_as<const bool &>;
        compile_time_constant<T::minimize_allocations> {};
    };

    /**
     * Standard @ref dynamic_programming_heap_allocation_strategy implementation.
     *
    ...
    struct dynamic_programming_heap_allocation_strategy_config {
    ...
    public:
        template<
            dynamic_programming_heap_allocation_strategy allocation_strategy = dynamic_programming_heap_allocation_strategy_config<true>,
        ...
        template<
            ...
            weight WEIGHT,
            dynamic_programming_heap_allocation_strategy allocation_strategy
        >
        auto align_strict(
            const sequence auto& down,
            const sequence auto& right,
...
#endif //OFFBYNULL_ALIGNER_GLOBAL_DYNAMIC_PROGRAMMING_HEAP_ALIGNER_H
