...
namespace offbynull::aligner::sequences::chunked_sequence {
     ...
     * @ref offbynull::aligner::sequences::chunked_sequence, referred to as a container creator pack.
     *
     * * Must create container for a sequence chunk via the `create_chunk_container()` function.
     *
    ...
    struct chunked_sequence_stack_container_creator_pack {
         ...
         * @return New container.
         * @throws std::runtime_error If `chunk_len != chunk_len_`.
         */
    ...
    public:
        /**
         * Construct an @ref offbynull::aligner::sequence::sequence::chunked_sequence instance.
         *
    ...
    /**
     * Convenience function to create an @ref offbynull::aligner::sequence::sequence::chunked_sequence instance using a
     * @ref offbynull::aligner::sequence::sequence::chunked_sequence_heap_container_creator_pack.
     *
     * @tparam debug_mode `true` to enable debugging logic, `false` otherwise.
     * @param seq Underlying sequence.
     * @param chunk_length Number of elements per chunk.
     * @return Newly created @ref offbynull::aligner::sequence::sequence::chunked_sequence instance.
     */
    ...
    /**
     * Convenience function to create an @ref offbynull::aligner::sequence::sequence::chunked_sequence instance using a
     * @ref offbynull::aligner::sequence::sequence::chunked_sequence_stack_container_creator_pack.
     *
     * @tparam debug_mode `true` to enable debugging logic, `false` otherwise.
