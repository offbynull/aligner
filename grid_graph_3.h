#ifndef GRID_GRAPH_3_H
#define GRID_GRAPH_3_H
...
template<typename _ND, typename _ED, typename T, T down_node_cnt, T right_node_cnt, bool error_check = true>
...
private:
    ...
    std::array<ND, down_node_cnt * right_node_cnt> nodes;
    std::array<edge_data_set, down_node_cnt * right_node_cnt> edges;
