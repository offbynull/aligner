...
namespace {
    ...
    TEST(GridGraphTest4, ListEdges) {
        auto x = [](auto&& g) {
            ...
            auto e = g.get_edges();
            std::multiset<E> actual {}; // TODO: I can't use being() and end() within set's constructor to automate this?
            for (auto _e : e) {
                actual.insert(_e);
            }
            EXPECT_EQ(
                ...
                (std::multiset<E> {
                    ...
                    std::pair { std::pair{0u, 0u}, std::pair{0u, 2u} },
                    std::pair { std::pair{0u, 0u}, std::pair{1u, 0u} },
                    std::pair { std::pair{0u, 0u}, std::pair{1u, 1u} },
                    std::pair { std::pair{0u, 0u}, std::pair{1u, 2u} },
                    ...
                    std::pair { std::pair{0u, 1u}, std::pair{1u, 2u} },
                    std::pair { std::pair{0u, 2u}, std::pair{1u, 2u} },
                    std::pair { std::pair{1u, 0u}, std::pair{1u, 2u} },
                    std::pair { std::pair{1u, 1u}, std::pair{1u, 2u} }
                })
            );
        };
