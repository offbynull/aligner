#ifndef GRID_GRAPH_2_H
#define GRID_GRAPH_2_H
...
private:
    ...
    std::vector<ND> nodes;
    std::vector<edge_data_set> edges;
...
public:
    grid_graph(T _down_node_cnt, T _right_node_cnt) :
    down_node_cnt{_down_node_cnt},
    right_node_cnt{_right_node_cnt},
    nodes{_down_node_cnt * _right_node_cnt},
    edges{_down_node_cnt * _right_node_cnt} {}
